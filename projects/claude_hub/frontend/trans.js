...
const DICT = {
  ...
  clPickMode: { en: 'How do you want to sign in?', zh: '用哪种方式登录？' },
  clModeSub: { en: 'Subscription (Pro / Max)', zh: '订阅登录（Pro / Max）' },
  clModeSubSub: { en: 'Recommended — usually cheaper than pay-as-you-go API', zh: '推荐，通常比按量付费的 API 更省钱' },
  clModeConsole: { en: 'Console account', zh: '控制台账号' },
  clModeConsoleSub: { en: 'Billed by API usage', zh: '按 API 用量计费' },

  // ── Codex 账号登录（health.js）──
  cxTitle: { en: 'Codex account', zh: 'Codex 账号' },
  cxChecking: { en: 'Checking login status…', zh: '正在检查登录状态…' },
  cxStatusFail: { en: 'Could not read login status: ', zh: '读取登录状态失败：' },
  cxLoggedIn: { en: 'Signed in', zh: '已登录' },
  cxNeedLogin: { en: 'Sign-in required', zh: '需要登录' },
  cxNotNeeded: { en: 'Not required', zh: '无需登录' },
  cxNoCli: { en: 'Codex CLI missing', zh: '未安装 Codex' },
  cxNoCliHint: {
    en: 'Codex is not installed yet. Install it first (engine step, or Settings → Runtime), then come back.',
    zh: '还没有安装 Codex。请先装好它（引导里的「选引擎」这一步，或设置 → 运行环境），再回来登录。',
  },
  cxThirdParty: {
    en: 'You are using the {p} provider, which connects with an API key — no OpenAI account needed.',
    zh: '你当前用的是 {p} 服务商，直接用 API Key 连接，不需要 OpenAI 账号，这一步可以跳过。',
  },
  cxWhy: {
    en: 'Codex needs to sign in before it can respond to your messages. Pick a way below and finish it in your browser — takes about a minute.',
    zh: 'Codex 必须先登录才能回应你的消息。选一种方式，在浏览器里完成登录即可，大约一分钟。',
  },
  cxPickMode: { en: 'How do you want to sign in?', zh: '用哪种方式登录？' },
  cxModeSub: { en: 'ChatGPT subscription', zh: 'ChatGPT 订阅登录' },
  cxModeSubSub: { en: 'Recommended — usually cheaper than pay-as-you-go API', zh: '推荐，通常比按量付费的 API 更省钱' },
  cxModeKey: { en: 'OpenAI API Key', zh: 'OpenAI API Key' },
  cxModeKeySub: { en: 'Billed by API usage, no ChatGPT account needed', zh: '按 API 用量计费，不需要 ChatGPT 账号' },
  cxStart: { en: 'Sign in to Codex', zh: '开始登录 Codex' },
  cxRelogin: { en: 'Sign in with another account', zh: '重新登录 / 换账号' },
  cxDoneOutside: { en: 'I signed in elsewhere — re-check', zh: '我已在别处登录，重新检测' },
  cxRecheck: { en: 'Re-check', zh: '重新检测' },
  cxManual: { en: 'Prefer a terminal? Run: ', zh: '也可以在终端里手动执行：' },
  cxStarting: { en: 'Starting sign-in…', zh: '正在启动登录…' },
  cxCancel: { en: 'Cancel', zh: '取消登录' },
  cxOpenUrl: { en: 'Open the authorization page ↗', zh: '打开授权页面 ↗' },
  cxCopyCode: { en: 'Copy code', zh: '复制短码' },
  cxCopied: { en: 'Code copied.', zh: '短码已复制。' },
  cxRunHint: {
    en: 'Open the page with the button below, sign in, and enter the one-time code shown here. Once you finish in the browser, this page updates automatically — nothing to paste back.',
    zh: '点下面的按钮打开页面，登录后填入这里显示的一次性短码。浏览器里填完就会自动完成，不需要回来粘贴任何东西。',
  },
  cxCodeLabel: { en: 'One-time code', zh: '一次性短码' },
  cxKeyPlaceholder: { en: 'Paste your OpenAI API Key (sk-...)', zh: '把 OpenAI API Key 粘贴到这里（sk- 开头）' },
  cxSubmitKey: { en: 'Submit key', zh: '提交密钥' },
  cxSubmitting: { en: 'Signing in…', zh: '登录中…' },
  cxNeedKey: { en: 'Please paste an API key first.', zh: '请先粘贴 API Key。' },
  ...
  // ── 软件本身的版本更新（对比本地 git 与 GitHub 最新 commit）──
  paneUpdate: { en: 'App update', zh: '软件更新' },
  paneUpdateDesc: {
    en: 'Check GitHub for a newer version and update with one click',
    zh: '检测 GitHub 上是否有新版本，一键更新',
  },
  paneUpdateChecking: { en: 'Checking…', zh: '检测中…' },
  paneUpdateAvailable: { en: 'New version available', zh: '有新版本' },
  paneUpdateUpToDate: { en: 'Up to date', zh: '已是最新' },
  paneUpdateUnknown: { en: 'Not checked yet', zh: '尚未检测' },
  updateCheckBtn: { en: 'Check for updates', zh: '检查更新' },
  updateCheckingNow: { en: 'Checking for updates…', zh: '正在检测更新…' },
  updateCheckFail: { en: 'Check failed: {err}', zh: '检测失败：{err}' },
  updateCurrentLabel: { en: 'Current version', zh: '当前版本' },
  updateLatestLabel: { en: 'Latest version', zh: '最新版本' },
  updateBranchLabel: { en: 'Branch', zh: '分支' },
  updateUpToDateHint: { en: 'You are on the latest version.', zh: '当前已是最新版本。' },
  updateAvailableHint: {
    en: 'A new version is available. Pulling will recompile and restart the service.',
    zh: '检测到新版本。更新会重新拉取代码、编译并重启服务。',
  },
  updateApplyBtn: { en: 'Pull update & restart', zh: '拉取更新并重启' },
  updateConfirm: {
    en: 'Pull the latest code now? The service will recompile and restart automatically, and you will be briefly disconnected.',
    zh: '现在拉取最新代码？服务会自动重新编译并重启，期间会短暂断开连接。',
  },
  updateApplying: { en: 'Updating, please do not close this page…', zh: '正在更新，请勿关闭此页面…' },
  updateApplyFail: { en: 'Update failed: {err}', zh: '更新失败：{err}' },
  updateApplyDone: {
    en: 'Update sent. The service is recompiling and restarting; this page will reconnect automatically.',
    zh: '更新已提交，服务正在重新编译并重启，页面会自动重新连接。',
  },
  ...
  cmd_goal_name: { en: 'Goal', zh: '目标' },
  cmd_goal_desc: {
    en: 'Mark the next message to be sent as "/goal ...". Does not touch what you already typed — click ✕ on the tag to cancel.',
    zh: '标记下一条消息将以 "/goal ..." 发出，不改写你已输入的内容——点标签上的 ✕ 可取消。',
  },
  cmd_skill_name: { en: 'Skill', zh: '技能' },
  cmd_skill_desc: { en: 'Pick a skill to prefix the next message with', zh: '选择一个技能，标记下一条消息以它开头' },
  ...
  shotToolCrop: { en: 'Crop', zh: '框选' },
  shotToolCircle: { en: 'Circle', zh: '圈选' },
  shotToolRect: { en: 'Box', zh: '方框' },
  shotToolArrow: { en: 'Arrow', zh: '箭头' },
  shotToolText: { en: 'Text', zh: '文字' },
  shotUndo: { en: 'Undo', zh: '撤销' },
  shotClear: { en: 'Clear', zh: '清空' },
  shotSizeS: { en: 'S', zh: '小' },
  shotSizeM: { en: 'M', zh: '中' },
  shotSizeL: { en: 'L', zh: '大' },
  shotTextPrompt: { en: 'Text to add:', zh: '要添加的文字：' },
  shotAnnTip: { en: 'Pick a tool to circle / arrow / annotate, or drag with Crop to cut the image', zh: '选工具可圈选/画箭头/加文字；选「框选」拖拽则裁剪图片' },
