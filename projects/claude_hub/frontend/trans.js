...
const DICT = {
  ...
  // ── 会话列表视图模式（单目录 / 收藏夹 / 全部目录）──
  listModeTitle: { en: 'Session list view', zh: '会话列表视图' },
  listModeSingle: { en: 'Current directory', zh: '单目录' },
  listModeSingleHint: { en: 'Sessions in the selected workspace', zh: '只看当前工作目录下的会话' },
  listModeFavorites: { en: 'Favorites', zh: '收藏夹' },
  listModeFavoritesHint: { en: 'Sessions you starred', zh: '被你收藏的会话' },
  listModeAll: { en: 'All directories', zh: '全部目录' },
  listModeAllHint: { en: 'Every indexed session across all workspaces', zh: '所有工作目录里已建索引的会话' },
  allSessionsFolder: { en: 'All directories', zh: '全部目录' },
  noAllSessions: { en: 'No indexed sessions yet — sessions created from now on show up here', zh: '暂无已索引会话——从现在起新建的会话都会出现在这里' },
  loadMoreSessions: { en: 'Load more', zh: '加载更多' },
  sessionsShownOf: { en: 'showing {shown} / {total}', zh: '已显示 {shown} / {total}' },
  clearFilter: { en: 'Clear filter', zh: '清除筛选' },
  // ── 目录筛选标签：右键菜单 + 折叠展开 ──
  dirCtxTitle: { en: 'Directory', zh: '目录' },
  dirCtxPath: { en: 'Full path', zh: '完整路径' },
  dirCtxCounts: { en: 'Contents', zh: '内容' },
  dirCtxDirs: { en: '{n} folders', zh: '{n} 个文件夹' },
  dirCtxFiles: { en: '{n} files', zh: '{n} 个文件' },
  dirCtxSessions: { en: '{n} sessions here', zh: '本目录 {n} 个会话' },
  dirCtxLoading: { en: 'Reading…', zh: '读取中…' },
  dirCtxMissing: { en: 'Directory no longer exists', zh: '该目录已不存在' },
  dirCtxCopyPath: { en: 'Copy path', zh: '复制路径' },
  dirCtxCopied: { en: 'Path copied', zh: '路径已复制' },
  dirCtxOpen: { en: 'Open this folder', zh: '打开该目录' },
  dirFilterMore: { en: 'More ({n})', zh: '更多（{n}）' },
  dirFilterLess: { en: 'Collapse', zh: '收起' },
  ...
  uploadCancel: { en: 'Cancel', zh: '取消' },
  uploadCanceled: { en: 'Upload canceled', zh: '已取消上传' },
